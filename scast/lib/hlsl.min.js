hljs.registerLanguage("hlsl", hlslDef());
hljs.registerLanguage("glsl", hlslDef());
hljs.registerLanguage("shader",hlslDef());
hljs.registerLanguage("cginc",hlslDef());
hljs.registerLanguage("compute",hlslDef());
function hlslDef(){
    "use strict"; const e = {
        className: "number",
        ...
        let t = ["", "1", "2", "3", "4", "1x1", "1x2", "1x3", "1x4", "2x1", "2x2", "2x3", "2x4", "3x1", "3x2", "3x3", "3x4", "4x1", "4x2", "4x3", "4x4"], a = []
            ...
            ; for (let e of o.split(" ")) for (let r of Array(16).keys()) n.push(e + r.toString())
                ; return {
                    ...
                    contains: [r.C_LINE_COMMENT_MODE, r.C_BLOCK_COMMENT_MODE, e, {
                        className: "meta",
                        begin: "#", end: "$"
                    }]
                }
